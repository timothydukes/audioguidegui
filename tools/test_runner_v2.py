#!/usr/bin/env python3
"""
test_runner_v2.py -- audioguidegui Phase 3 (v2: full-run mode also prints stderr and, on failure, the stdout tail)
Headless verification of the AGGUI progress protocol and the subprocess runner.

Run from the repo root:

  python3 tools/test_runner_v2.py --selftest
  ...
  python3 tools/test_runner_v2.py
